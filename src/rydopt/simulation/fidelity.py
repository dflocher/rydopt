...
def process_fidelity(gate: Gate, pulse: PulseAnsatz, params: ParamsTuple, tol: float = 1e-7) -> jnp.ndarray:
...
def average_gate_fidelity(gate: Gate, pulse: PulseAnsatz, params: ParamsTuple, tol: float = 1e-7) -> jnp.ndarray:
