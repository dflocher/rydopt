...
infidelities_nodecay_CZCZCZ_TR_12_32 = [
    1.3755e-06,
    4.0219e-07,
    8.9060e-07,
    2.9989e-06,
...
def plot_TR_vs_Vnnn(Vnnns_list, TRs_list, infidelities_list, eps_list):
    ...
    axin.semilogx(
        Vnnns_list, eps_list, "x", markersize=4, color="gray", markerfacecolor="none"
    )
    ...
    plt.show()
    fig.savefig(
        "Figs/CZCZCZ_infidelity_and_TR_vs_Vnnn_params12.pdf",
        bbox_inches="tight",
        pad_inches=0.02,
    )
