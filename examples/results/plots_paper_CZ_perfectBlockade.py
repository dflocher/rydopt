...
infidelities_nodecay_CZ_TR_gen = [
    4.2939e-09,
    4.2937e-09,
    4.1794e-09,
    4.2404e-09,
...
def plot_pulses(pulse, params_list):
    ...
    ax.legend(
        fontsize=8, handlelength=2.2, loc="upper left", bbox_to_anchor=(0.53, 1.0)
    )
    ax.grid()
    plt.show()
