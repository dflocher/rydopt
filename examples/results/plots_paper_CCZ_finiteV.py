...
infidelities_nodecay_CCZ_TR_32_4 = [
    8.3665e-04,
    1.7763e-05,
    2.9809e-05,
    8.9613e-07,
...
infidelities_nodecay_epsCCZ_TR_32_4 = [
    3.4878e-05,
    1.8017e-05,
    3.2920e-07,
    1.5238e-06,
...
infidelities_nodecay_CCZ_TR_32_05 = [
    1.9136e-04,
    7.2420e-06,
    7.0732e-06,
    3.7913e-06,
...
infidelities_nodecay_epsCCZ_TR_32_05 = [
    4.6890e-05,
    2.4097e-06,
    1.6522e-06,
    4.9635e-06,
...
def postprocess_V_sensitivity(
    ...
    print(
        "Rnnn  : ["
        + ", ".join("{rnnn:.8f}".format(rnnn=rnnn) for rnnn in Rnnn_array)
        + "]"
    )
    print(
        "Rnn   : [" + ", ".join("{rnn:.8f}".format(rnn=rnn) for rnn in Rnn_array) + "]"
    )
    print(
        "Vnnn  : ["
        + ", ".join("{vnnn:.8f}".format(vnnn=vnnn) for vnnn in Vnnn_array)
        + "]"
    )
    print(
        "Vnn   : [" + ", ".join("{vnn:.8f}".format(vnn=vnn) for vnn in Vnn_array) + "]"
    )
    print(
        "infid : ["
        + ", ".join("{infid:.4e}".format(infid=infid) for infid in infidelities)
        + "]"
    )
    return Rnnn_array, infidelities


def plots_combined_row1(
    nParams_list_A,
    TRs_list_A,
    eps_TRs_list_A,
    infids_list_A,
    ...
    fig, ax = plt.subplots(
        1, 3, width_ratios=[1.2, 1, 1], figsize=(7.0, 1.7), layout="constrained"
    )
    #
    ...
    (epsccz_tr_A,) = ax0a.plot(
        nParams_list_A, eps_TRs_list_A, "^", markersize=3.5, color=color2
    )
    ...
    ax[1].legend(
        [(ccz_tr_A, ccz_infid_A), (epsccz_tr_A, epsccz_infid_A)],
        ["CCZ'", "$\epsilon$-CCZ'"],
        numpoints=1,
    ...
    (epsccz_tr_B,) = ax1a.plot(
        nParams_list_B, eps_TRs_list_B, "^", markersize=3.5, color=color2
    )
    ...
    ax[2].legend(
        [(ccz_tr_B, ccz_infid_B), (epsccz_tr_B, epsccz_infid_B)],
        ["CCZ'", "$\epsilon$-CCZ'"],
        numpoints=1,
        handler_map={tuple: HandlerTuple(ndivide=None)},
        fontsize=8,
...
def plots_combined_row2(
    ...
    #
    ax[0].semilogy(
        dnnns_list_B, infids_list_B, linestyle="solid", color="tab:orange", label="CCZ'"
    )
    ax[0].semilogy(
        [], [], linestyle="dashed", color="tab:purple", label="$\epsilon$-CCZ'"
    )
    ...
    #
    ax[1].semilogy(
        dnnns_list_C, infids_list_C, linestyle="solid", color="tab:orange", label="CCZ'"
    )
    ax[1].semilogy(
        dnnns_list_C,
        eps_infids_list_C,
    ...
    #
    ax[2].semilogy(
        dnnns_list_D, infids_list_D, linestyle="solid", color="tab:orange", label="CCZ'"
    )
    ax[2].semilogy(
        dnnns_list_D,
        eps_infids_list_D,
